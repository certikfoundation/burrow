...
[Burrow](https://github.com/certikfoundation/burrow) is a permissioned Ethereum smart-contract blockchain node which provides transaction finality and high transaction throughput 
...
have a secret to hold any validator keys. The provided script, `addresses.sh` automatically provisions a number of files using the [burrow](https://github.com/certikfoundation/burrow) toolkit, 
...
| `config` | the [burrow configuration file](https://github.com/certikfoundation/burrow/blob/develop/tests/chain/burrow.toml) | `{}` |
...
| `image.repository` | image repository | `"certikfoundation/burrow"` |
