...
type NodeInfo struct {
	ID                   github_com_hyperledger_burrow_crypto.Address  `protobuf:"bytes,1,opt,name=ID,proto3,customtype=github.com/certikfoundation/burrow/crypto.Address" json:"ID"`
	...
	Channels             github_com_hyperledger_burrow_binary.HexBytes `protobuf:"bytes,5,opt,name=Channels,proto3,customtype=github.com/certikfoundation/burrow/binary.HexBytes" json:"Channels"`
