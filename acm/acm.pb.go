...
type Account struct {
	...
	CodeHash github_com_hyperledger_burrow_binary.HexBytes `protobuf:"bytes,8,opt,name=CodeHash,proto3,customtype=github.com/certikfoundation/burrow/binary.HexBytes" json:"-"`
	...
	Forebear             *github_com_hyperledger_burrow_crypto.Address `protobuf:"bytes,10,opt,name=Forebear,proto3,customtype=github.com/certikfoundation/burrow/crypto.Address" json:"Forebear,omitempty"`
...
type ContractMeta struct {
	...
	MetadataHash github_com_hyperledger_burrow_binary.HexBytes `protobuf:"bytes,2,opt,name=MetadataHash,proto3,customtype=github.com/certikfoundation/burrow/binary.HexBytes" json:"MetadataHash"`
