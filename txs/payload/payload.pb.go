...
type CallTx struct {
	...
	Address *github_com_hyperledger_burrow_crypto.Address `protobuf:"bytes,2,opt,name=Address,proto3,customtype=github.com/certikfoundation/burrow/crypto.Address" json:"Address,omitempty"`
	...
	// EVM bytecode
	Data github_com_hyperledger_burrow_binary.HexBytes `protobuf:"bytes,5,opt,name=Data,proto3,customtype=github.com/certikfoundation/burrow/binary.HexBytes" json:"Data"`
	// WASM bytecode
	WASM github_com_hyperledger_burrow_binary.HexBytes `protobuf:"bytes,6,opt,name=WASM,proto3,customtype=github.com/certikfoundation/burrow/binary.HexBytes" json:"tags,omitempty"`
...
type ContractMeta struct {
	CodeHash             github_com_hyperledger_burrow_binary.HexBytes `protobuf:"bytes,1,opt,name=CodeHash,proto3,customtype=github.com/certikfoundation/burrow/binary.HexBytes" json:"CodeHash"`
...
type ProposalTx struct {
	...
	ProposalHash         *github_com_hyperledger_burrow_binary.HexBytes `protobuf:"bytes,3,opt,name=ProposalHash,proto3,customtype=github.com/certikfoundation/burrow/binary.HexBytes" json:"ProposalHash,omitempty"`
...
type Ballot struct {
	...
	FinalizingTx         *github_com_hyperledger_burrow_binary.HexBytes `protobuf:"bytes,2,opt,name=FinalizingTx,proto3,customtype=github.com/certikfoundation/burrow/binary.HexBytes" json:"FinalizingTx,omitempty"`
