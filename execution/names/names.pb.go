...
type Entry struct {
	...
	Owner github_com_hyperledger_burrow_crypto.Address `protobuf:"bytes,2,opt,name=Owner,proto3,customtype=github.com/certikfoundation/burrow/crypto.Address" json:"Owner"`
